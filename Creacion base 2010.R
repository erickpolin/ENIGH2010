...
Conc<-Conc%>%
  select(folioviv,foliohog,gasmon,tot_resi,ingcor,ingtrab,trabajo,negocio,otros_trab,rentas,utilidad,
         arrenda,transfer,jubila,beca,donativo,remesa,bene_gob,esp_hog,esp_inst,esti,otros,factor,upm,est_dis,tam_loc)

names(Conc)<- c("folioviv", "foliohog","gasto","tot_integ", "ing_cor", "ingtrab", "trabajo", "negocio", "otros_trab", "rentas", "utilidad",
...
Conc <- Conc%>%
  mutate(gasto=(gasto/Deflactores)*100,ing_cor=(ing_cor/Deflactores)*100, ingtrab=(ingtrab/Deflactores)*100, trabajo=(trabajo/Deflactores)*100, 
...
prueba<-c_DECIL_ES%>%
  mutate(`ING COR2010`=`ING COR2010`, prueba=TRABAJO2010+RENTAS2010+JUBILACION2010+BECAS2010+DONATIVOS2010+REMESAS2010+BENEGOBIERNO2010+`TRANS HOG2010`+`TRANS INST2010`+`ESTIM ALQU2010`+`OTROS INGRESOS2010`)
...
write.dbf(c_DECIL_LI,file = "Nacional por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional por fuente por DECIL LS 2010.dbf")
...
#ahora vamos a ponerle nombre a las columnas
names(c_Bottom_40_ES)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")

names(c_Bottom_40_SE)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")

names(c_Bottom_40_CV)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")

names(c_Bottom_40_LI)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")
...
write.dbf(Consumo,file = "Nacional Consumo  por Bottom_40 2010.dbf")
write.dbf(Consumo_SE,file="Nacional Consumo  por Bottom_40 2010 SE.dbf")
write.dbf(c_Bottom_40_ES,file = "Nacional por fuente por Bottom_40 estimaciones 2010.dbf")
write.dbf(c_Bottom_40_SE,file = "Nacional por fuente por Bottom_40 errores standard 2010.dbf")
write.dbf(c_Bottom_40_CV,file = "Nacional por fuente por Bottom_40 CV 2010.dbf")
write.dbf(c_Bottom_40_LI,file = "Nacional por fuente por Bottom_40 LI 2010.dbf")
write.dbf(c_Bottom_40_ES,file = "Nacional por fuente por Bottom_40 LS 2010.dbf")
...
#ahora vamos a ponerle nombre a las columnas
names(c_ENTIDAD_ES)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")

names(c_ENTIDAD_SE)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")

names(c_ENTIDAD_CV)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")

names(c_ENTIDAD_LI)=c("ING COR2010", "TRABAJO2010", "SUBORDINADO2010", "NEGOCIOS2010","OTROS TRAB2010", "RENTAS2010","UTILIDAD2010", "ARRENDA2010", "TRANSFER2010","JUBILACION2010", "BECAS2010", "DONATIVOS2010", "REMESAS2010", "BENEGOBIERNO2010", "TRANS HOG2010", "TRANS INST2010", "ESTIM ALQU2010", "OTROS INGRESOS2010")
...
write.dbf(Consumo,file = "ESTADOS MEAN Consumo 2010.dbf")
write.dbf(Consumo_SE,file="ESTADOS MEAN 2010 SE.dbf")
write.dbf(c_ENTIDAD_ES,file = "ESTADOS MEAN por fuente por estimaciones 2010.dbf")
write.dbf(c_ENTIDAD_SE,file = "ESTADOS MEAN por fuente por errores standard 2010.dbf")
write.dbf(c_ENTIDAD_CV,file = "ESTADOS MEAN por fuente por CV 2010.dbf")
write.dbf(c_ENTIDAD_LI,file = "ESTADOS MEAN por fuente por LI 2010.dbf")
write.dbf(c_ENTIDAD_ES,file = "ESTADOS MEAN por fuente por LS 2010.dbf")
...
write.dbf(Consumo,file = "ESTADOS Consumo bottom 40 2010.dbf")
write.dbf(Consumo_SE,file="ESTADOS Consumo bottom 40 2010 SE.dbf")
write.dbf(c_ENTIDAD_ES,file = "ESTADOS bottom 40 por fuente por ENTIDAD estimaciones 2010.dbf")
write.dbf(c_ENTIDAD_SE,file = "ESTADOS bottom 40 fuente por ENTIDAD errores standard 2010.dbf")
...
write.dbf(Consumo,file = "ESTADOS Consumo upper 60 2010.dbf")
write.dbf(Consumo_SE,file="ESTADOS Consumo upper 60 2010 SE.dbf")
write.dbf(c_ENTIDAD_ES,file = "ESTADOS upper 60 por fuente por ENTIDAD estimaciones 2010.dbf")
write.dbf(c_ENTIDAD_SE,file = "ESTADOS upper 60 fuente por ENTIDAD errores standard 2010.dbf")
